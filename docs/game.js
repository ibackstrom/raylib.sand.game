...
var ASM_CONSTS = {
  291416: () => { if (document.fullscreenElement) return 1; },  
 291462: () => { return Module.canvas.width; },  
 291494: () => { return parseInt(Module.canvas.style.width); },  
 291542: () => { document.exitFullscreen(); },  
 291569: () => { setTimeout(function() { Module.requestFullscreen(false, false); }, 100); },  
 291642: () => { if (document.fullscreenElement) return 1; },  
 291688: () => { return Module.canvas.width; },  
 291720: () => { return screen.width; },  
 291745: () => { document.exitFullscreen(); },  
 291772: () => { setTimeout(function() { Module.requestFullscreen(false, true); setTimeout(function() { canvas.style.width="unset"; }, 100); }, 100); },  
 291905: () => { return window.innerWidth; },  
 291931: () => { return window.innerHeight; },  
 291958: () => { if (document.fullscreenElement) return 1; },  
 292004: () => { return Module.canvas.width; },  
 292036: () => { return parseInt(Module.canvas.style.width); },  
 292084: () => { if (document.fullscreenElement) return 1; },  
 292130: () => { return Module.canvas.width; },  
 292162: () => { return screen.width; },  
 292187: () => { return window.innerWidth; },  
 292213: () => { return window.innerHeight; },  
 292240: () => { if (document.fullscreenElement) return 1; },  
 292286: () => { return Module.canvas.width; },  
 292318: () => { return screen.width; },  
 292343: () => { document.exitFullscreen(); },  
 292370: () => { if (document.fullscreenElement) return 1; },  
 292416: () => { return Module.canvas.width; },  
 292448: () => { return parseInt(Module.canvas.style.width); },  
 292496: () => { document.exitFullscreen(); },  
 292523: ($0) => { Module.canvas.style.opacity = $0; },  
 292561: () => { return screen.width; },  
 292586: () => { return screen.height; },  
 292612: () => { return window.screenX; },  
 292639: () => { return window.screenY; },  
 292666: () => { return window.devicePixelRatio; },  
 292702: ($0) => { navigator.clipboard.writeText(UTF8ToString($0)); },  
 292755: ($0) => { Module.canvas.style.cursor = UTF8ToString($0); },  
 292806: () => { Module.canvas.style.cursor = 'none'; },  
 292843: ($0, $1, $2, $3) => { try { navigator.getGamepads()[$0].vibrationActuator.playEffect('dual-rumble', { startDelay: 0, duration: $3, weakMagnitude: $1, strongMagnitude: $2 }); } catch (e) { try { navigator.getGamepads()[$0].hapticActuators[0].pulse($2, $3); } catch (e) { } } },  
 293099: ($0) => { Module.canvas.style.cursor = UTF8ToString($0); },  
 293150: () => { if (document.pointerLockElement) return 1; },  
 293197: () => { if (document.fullscreenElement) return 1; },  
 293243: () => { return window.innerWidth; },  
 293269: () => { return window.innerHeight; }
};
